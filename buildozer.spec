...
# (str) Package name
package.name = vocably

# (str) Package domain (needed for android/ios packaging)
package.domain = org.vocably

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,mp3,txt
...
requirements = python3,kivy==master,requests,gtts,kivymd,pillow,openssl,googletrans,SpeechRecognition,httpcore
...
presplash.filename = Vocably.png
